...
class Fructose():
    def __init__(self, client=None, model=DEFAULT_MODEL, appkey=DEFAULT_APPKEY, system_template_path=None, chain_of_thought_template_path=None, debug=False):
        if client is None:
